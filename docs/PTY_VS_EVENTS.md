...
PTY until EOF/EIO, one complete read interval is quiet, or the configured total
post-exit deadline expires. This preserves final output without waiting
indefinitely for descendant processes that retain and write through the slave
descriptor.
